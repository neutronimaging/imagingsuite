...
`$CPCMD $REPOSPATH/lib/libUnpublPreProcessingGUI.1.0.0.dylib $DEST/Contents/Frameworks`
`$CPCMD $REPOSPATH/lib/libUnpublPreProcessing.1.0.0.dylib $DEST/Contents/Frameworks`
`$CPCMD $REPOSPATH/lib/libUnpublishedImagingAlgorithms.1.0.0.dylib $DEST/Contents/Frameworks`
...
install_name_tool -change libkipl.1.dylib @executable_path/../Frameworks/libkipl.1.dylib libUnpublishedImagingAlgorithms.1.0.0.dylib
install_name_tool -change libImagingAlgorithms.1.dylib @executable_path/../Frameworks/libImagingAlgorithms.1.dylib libUnpublishedImagingAlgorithms.1.0.0.dylib
...
install_name_tool -change libkipl.1.dylib @executable_path/../Frameworks/libkipl.1.dylib libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libModuleConfig.1.dylib @executable_path/../Frameworks/libModuleConfig.1.dylib libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libReconFramework.1.dylib  @executable_path/../Frameworks/libReconFramework.1.dylib  libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libImagingAlgorithms.1.dylib  @executable_path/../Frameworks/libImagingAlgorithms.1.dylib  libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libUnpublishedImagingAlgorithms.1.dylib  @executable_path/../Frameworks/libUnpublishedImagingAlgorithms.1.dylib  libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libNeXus.1.dylib @executable_path/../Frameworks/libNeXus.1.dylib libUnpublPreProcessing.1.0.0.dylib
install_name_tool -change libNeXusCPP.1.dylib @executable_path/../Frameworks/libNeXusCPP.1.dylib libUnpublPreProcessing.1.0.0.dylib

install_name_tool -change libkipl.1.dylib @executable_path/../Frameworks/libkipl.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libModuleConfig.1.dylib @executable_path/../Frameworks/libModuleConfig.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libImagingAlgorithms.1.dylib @executable_path/../Frameworks/libImagingAlgorithms.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libUnpublishedImagingAlgorithms.1.dylib @executable_path/../Frameworks/libUnpublishedImagingAlgorithms.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libReconFramework.1.dylib @executable_path/../Frameworks/libReconFramework.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libUnpublPreProcessing.1.dylib @executable_path/../Frameworks/libUnpublPreProcessing.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libStdPreprocModules.1.dylib @executable_path/../Frameworks/libStdPreprocModules.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
install_name_tool -change libQtModuleConfigure.1.dylib @executable_path/../Frameworks/libQtModuleConfigure.1.dylib libUnpublPreProcessingGUI.1.0.0.dylib
