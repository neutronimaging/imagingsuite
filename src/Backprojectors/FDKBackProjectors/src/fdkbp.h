...
protected:
    ...
    void project_volume_onto_image_reference (kipl::base::TImage<float,2>  &cbi, double *proj_matrix, double *nrm);              ///< Multi core accelerated FDK implementation
    void project_volume_onto_image_c (kipl::base::TImage<float,2>  &cbi, double *proj_matrix, double *nrm);         ///< Reference FDK implementation is the most straightforward implementation, also it is the slowest
