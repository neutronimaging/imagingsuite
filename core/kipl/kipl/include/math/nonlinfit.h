...
public:
    ...
    void fit(Array1D<double> &x, Array1D<double> &y, Array1D<double> &sig, Nonlinear::TNTfit::FitFunctionBase &fn);
    void fit(arma::vec &x, arma::vec &y,
                                 arma::vec &sig,
                                 Nonlinear::TNTfit::FitFunctionBase &fn);
private:
    ...
    void mrqcof(Nonlinear::TNTfit::FitFunctionBase &fn, Array1D<double> &x, Array1D<double> &y, Array1D<double> &sig, Array2D<double> &alpha, Array1D<double> &beta);
...
/// \brief Function implementation of a sum of Gaussians
class KIPLSHARED_EXPORT SumOfGaussians: public Nonlinear::TNTfit::FitFunctionBase
{
public:
    /// \brief Constructor
    /// \param n Number of gassians in the sum
...
/// \brief Function implementation of a sum of Lorenzians
class KIPLSHARED_EXPORT Lorenzian: public Nonlinear::TNTfit::FitFunctionBase
{
public:
    /// \brief Constructor
    /// \param n Number of Lorenzians in the sum
...
class KIPLSHARED_EXPORT Voight : public Nonlinear::TNTfit::FitFunctionBase
{
public:
    /// \brief Constructor
    ///
