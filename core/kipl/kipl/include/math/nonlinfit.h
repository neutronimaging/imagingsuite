...
private:
    ...
    void mrqcof(Nonlinear::armafit::FitFunctionBase &fn, arma::vec &x, arma::vec &y, arma::vec &sig, arma::mat &alpha, arma::vec &beta);
    void covsrt(arma::mat &covar, Nonlinear::armafit::FitFunctionBase &fn);
    void gaussj(arma::mat &a, arma::mat &b);

};

/// \brief Function implementation of a sum of Gaussians
class KIPLSHARED_EXPORT SumOfGaussians: public Nonlinear::armafit::FitFunctionBase
{
public:
    /// \brief Constructor
    /// \param n Number of gassians in the sum
...
class KIPLSHARED_EXPORT Voight : public Nonlinear::armafit::FitFunctionBase
{
public:
    /// \brief Constructor
    ///
