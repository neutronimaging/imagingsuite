...
#ifndef REFERENCEIMAGECORRECTION_ORIGINAL_H
#define REFERENCEIMAGECORRECTION_ORIGINAL_H
...
protected:
    ...
    ImagingAlgorithms::original::ReferenceImageCorrection::eMaskCreationMethod m_MaskMethod;
...
void IMAGINGALGORITHMSSHARED_EXPORT string2enum(std::string str, ImagingAlgorithms::original::ReferenceImageCorrection::eReferenceMethod &erm);
std::string IMAGINGALGORITHMSSHARED_EXPORT enum2string(const ImagingAlgorithms::original::ReferenceImageCorrection::eReferenceMethod &erm);
std::ostream IMAGINGALGORITHMSSHARED_EXPORT & operator<<(ostream & s, ImagingAlgorithms::original::ReferenceImageCorrection::eReferenceMethod erm);

void IMAGINGALGORITHMSSHARED_EXPORT string2enum(std::string str, ImagingAlgorithms::original::ReferenceImageCorrection::eBBOptions &ebo);
std::string IMAGINGALGORITHMSSHARED_EXPORT enum2string(const ImagingAlgorithms::original::ReferenceImageCorrection::eBBOptions &ebo);
std::ostream IMAGINGALGORITHMSSHARED_EXPORT & operator<<(ostream & s, ImagingAlgorithms::original::ReferenceImageCorrection::eBBOptions ebo);

void IMAGINGALGORITHMSSHARED_EXPORT string2enum(std::string str, ImagingAlgorithms::original::ReferenceImageCorrection::eInterpOrderX &eim_x);
std::string IMAGINGALGORITHMSSHARED_EXPORT enum2string(const ImagingAlgorithms::original::ReferenceImageCorrection::eInterpOrderX &eim_x);
std::ostream IMAGINGALGORITHMSSHARED_EXPORT & operator<<(ostream & s, ImagingAlgorithms::original::ReferenceImageCorrection::eInterpOrderX eim_x);

void IMAGINGALGORITHMSSHARED_EXPORT string2enum(std::string str, ImagingAlgorithms::original::ReferenceImageCorrection::eInterpOrderY &eim_y);
...
void IMAGINGALGORITHMSSHARED_EXPORT string2enum(const std::string &str, ImagingAlgorithms::original::ReferenceImageCorrection::eMaskCreationMethod &emask);
std::string IMAGINGALGORITHMSSHARED_EXPORT enum2string(const ImagingAlgorithms::original::ReferenceImageCorrection::eMaskCreationMethod &emask);
