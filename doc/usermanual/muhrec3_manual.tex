...
\begin{itemize}
	...
	\item Ring cleaning.
\end{itemize}
The projection filter used for parallel beam reconstruction is not needed as it is part of the CBCT backprojection module.
