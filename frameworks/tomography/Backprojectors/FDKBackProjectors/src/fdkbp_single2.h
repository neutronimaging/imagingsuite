...
#ifndef FDKBP_SINGLE2_H
#define FDKBP_SINGLE2_H
#include "fftw3.h"
...
class FDKBACKPROJSHARED_EXPORT FDKbp_single2 : public FdkReconBase
{
public:
    FDKbp_single2(kipl::interactors::InteractionBase *interactor=nullptr);
    ~FDKbp_single2();
