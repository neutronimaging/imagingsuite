...
SOURCES +=  tst_titerativebackproj.cpp
...
LIBS += -lkipl -lQtModuleConfigure -lQtAddons -lImagingAlgorithms -lReconFramework -lModuleConfig -lReconAlgorithms -lIterativeBackProj
...
INCLUDEPATH += $$PWD/../../Backprojectors/IterativeBackProj/src
DEPENDPATH += $$PWD/../../Backprojectors/IterativeBackProj/src
