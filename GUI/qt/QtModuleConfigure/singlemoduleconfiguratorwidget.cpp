...
void SingleModuleConfiguratorWidget::Configure( const std::string &sApplicationName, 
                                                ...
                                                const std::string &sCategory)
{
    ...
    m_ModuleConfig.setAppPath(sApplicationPath,m_sCategory);
}

void SingleModuleConfiguratorWidget::setDescriptionLabel(const QString &lbl)
{
...
{
    SingleModuleSettingsDialog dlg(m_sApplication, m_sApplicationPath, m_sCategory,m_sDefaultModuleSource,this);
...
//     m_sCategory(sCategory),
//     m_sDefaultModuleSource(sDefaultModuleSource),
//     m_ModuleConfig(m_sApplicationPath, m_sCategory)
// {
//     BuildDialog();
