...
public:
    ...
    void Configure(const std::string &sApplicationName, 
    ...
    void setDescriptionLabel(const QString &lbl);
...
//     kipl::logging::Logger logger;
// public:
//     explicit SingleModuleSettingsDialog(const std::string &sApplicationName, const std::string &sApplicationPath, const std::string &sCategory, const std::string & sDefaultModuleSource ,QWidget *parent);
