...
*/
{
	...
	switch (inbitpix) {
	case USHORT_IMG : bitpix=SHORT_IMG; break;
	case ULONG_IMG  : bitpix=LONG_IMG;  break;
	case SBYTE_IMG  : bitpix=BYTE_IMG;  break;
	default         : bitpix=inbitpix;  break;
	}
...
*/
{
    ...
    short *cbuf = NULL;	/* compressed data */
    short *sbuff = NULL;
    unsigned short *usbuff=NULL;
    unsigned int *uintbuff=NULL, uintflagval;
    ...
    signed char *sbbuff=NULL;
    unsigned char *usbbuff=NULL;
    ...
    /* =========================================================================== */
	    ...
	    */
		...
		hcompscale = (float)(hcompscale * -1.0);
	    }
